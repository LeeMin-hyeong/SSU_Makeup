...
public class SurveyQ4_12Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ4_12Fragment newInstance() {
        return new SurveyQ4_12Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q4_12);
        answer1.setText(R.string.a4_12_1);
        answer2.setText(R.string.a4_12_2);
        answer3.setText(R.string.a4_12_3);
        answer4.setText(R.string.a4_12_4);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,4,12);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ4_13Fragment.newInstance());
    }
