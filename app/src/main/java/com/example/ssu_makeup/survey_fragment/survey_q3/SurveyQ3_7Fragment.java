...
public class SurveyQ3_7Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ3_7Fragment newInstance() {
        return new SurveyQ3_7Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q3_7);
        answer1.setText(R.string.a3_7_1);
        answer2.setText(R.string.a3_7_2);
        answer3.setText(R.string.a3_7_3);
        answer4.setText(R.string.a3_7_4);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,3,7);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ3_8Fragment.newInstance());
    }
