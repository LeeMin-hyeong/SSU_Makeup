...
//    Button answer5;
    ...
    public static SurveyQ4_1Fragment newInstance() {
        return new SurveyQ4_1Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q4_1);
        answer1.setText(R.string.a4_1_1);
        answer2.setText(R.string.a4_1_2);
        answer3.setText(R.string.a4_1_3);
        answer4.setText(R.string.a4_1_4);
//        answer5.setText(R.string.a4_1_5);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,4,1);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ4_2Fragment.newInstance());
    }
