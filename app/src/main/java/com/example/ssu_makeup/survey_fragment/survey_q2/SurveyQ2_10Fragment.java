...
public class SurveyQ2_10Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ2_10Fragment newInstance() {
        return new SurveyQ2_10Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q2_10);
        answer1.setText(R.string.a2_10_1);
        answer2.setText(R.string.a2_10_2);
        answer3.setText(R.string.a2_10_3);
        answer4.setText(R.string.a2_10_4);
        answer5.setText(R.string.a2_10_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ2_11Fragment.newInstance());
    }
