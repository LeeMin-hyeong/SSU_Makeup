...
public class SurveyQ4_8Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ4_8Fragment newInstance() {
        return new SurveyQ4_8Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q4_8);
        answer1.setText(R.string.a4_8_1);
        answer2.setText(R.string.a4_8_2);
        answer3.setText(R.string.a4_8_3);
        answer4.setText(R.string.a4_8_4);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,4,8);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ4_9Fragment.newInstance());
    }
