...
public class SurveyQ2_4Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ2_4Fragment newInstance() {
        return new SurveyQ2_4Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q2_4);
        answer1.setText(R.string.a2_4_1);
        answer2.setText(R.string.a2_4_2);
        answer3.setText(R.string.a2_4_3);
        answer4.setText(R.string.a2_4_4);
        answer5.setText(R.string.a2_4_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ2_5Fragment.newInstance());
    }
