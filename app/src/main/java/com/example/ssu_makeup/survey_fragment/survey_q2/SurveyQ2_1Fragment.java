...
//    Button answer5;
    ...
    public static SurveyQ2_1Fragment newInstance() {
        return new SurveyQ2_1Fragment();
    }
    @Override
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,2,1);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ2_2Fragment.newInstance());
    }
