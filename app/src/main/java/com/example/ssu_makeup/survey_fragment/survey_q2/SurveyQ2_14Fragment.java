...
public class SurveyQ2_14Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ2_14Fragment newInstance() {
        return new SurveyQ2_14Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q2_14);
        answer1.setText(R.string.a2_14_1);
        answer2.setText(R.string.a2_14_2);
        answer3.setText(R.string.a2_14_3);
        answer4.setText(R.string.a2_14_4);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,2,14);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ2_15Fragment.newInstance());
    }
