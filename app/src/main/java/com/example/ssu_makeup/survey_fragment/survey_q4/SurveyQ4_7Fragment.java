...
public class SurveyQ4_7Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ4_7Fragment newInstance() {
        return new SurveyQ4_7Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q4_7);
        answer1.setText(R.string.a4_7_1);
        answer2.setText(R.string.a4_7_2);
        answer3.setText(R.string.a4_7_3);
        answer4.setText(R.string.a4_7_4);
        answer5.setText(R.string.a4_7_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ4_8Fragment.newInstance());
    }
