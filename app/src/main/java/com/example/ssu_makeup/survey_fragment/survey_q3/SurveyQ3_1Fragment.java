...
public class SurveyQ3_1Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ3_1Fragment newInstance() {
        return new SurveyQ3_1Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q3_1);
        answer1.setText(R.string.a3_1_1);
        answer2.setText(R.string.a3_1_2);
        answer3.setText(R.string.a3_1_3);
        answer4.setText(R.string.a3_1_4);
        answer5.setText(R.string.a3_1_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ3_2Fragment.newInstance());
    }
