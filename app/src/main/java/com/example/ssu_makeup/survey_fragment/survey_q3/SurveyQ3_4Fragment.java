...
public class SurveyQ3_4Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ3_4Fragment newInstance() {
        return new SurveyQ3_4Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q3_4);
        answer1.setText(R.string.a3_4_1);
        answer2.setText(R.string.a3_4_2);
        answer3.setText(R.string.a3_4_3);
        answer4.setText(R.string.a3_4_4);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,3,4);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ3_5Fragment.newInstance());
    }
