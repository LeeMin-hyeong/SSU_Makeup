...
public class SurveyQ3_9Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ3_9Fragment newInstance() {
        return new SurveyQ3_9Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q3_9);
        answer1.setText(R.string.a3_9_1);
        answer2.setText(R.string.a3_9_2);
        answer3.setText(R.string.a3_9_3);
        answer4.setText(R.string.a3_9_4);
        answer5.setText(R.string.a3_9_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ3_10Fragment.newInstance());
    }
