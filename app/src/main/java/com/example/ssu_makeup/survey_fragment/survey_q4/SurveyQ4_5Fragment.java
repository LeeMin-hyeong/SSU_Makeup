...
public class SurveyQ4_5Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ4_5Fragment newInstance() {
        return new SurveyQ4_5Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q4_5);
        answer1.setText(R.string.a4_5_1);
        answer2.setText(R.string.a4_5_2);
        answer3.setText(R.string.a4_5_3);
        answer4.setText(R.string.a4_5_4);
        answer5.setText(R.string.a4_5_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ4_6Fragment.newInstance());
    }
