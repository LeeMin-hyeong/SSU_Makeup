...
public class SurveyQ4_10Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ4_10Fragment newInstance() {
        return new SurveyQ4_10Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q4_10);
        answer1.setText(R.string.a4_10_1);
        answer2.setText(R.string.a4_10_2);
        answer3.setText(R.string.a4_10_3);
        answer4.setText(R.string.a4_10_4);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,4,10);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ4_11Fragment.newInstance());
    }
