...
public class SurveyQ4_17Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ4_17Fragment newInstance() {
        return new SurveyQ4_17Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q4_17);
        answer1.setText(R.string.a4_17_1);
        answer2.setText(R.string.a4_17_2);
        answer3.setText(R.string.a4_17_3);
        answer4.setText(R.string.a4_17_4);
