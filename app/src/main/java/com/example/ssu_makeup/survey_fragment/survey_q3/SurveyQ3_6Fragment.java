...
public class SurveyQ3_6Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ3_6Fragment newInstance() {
        return new SurveyQ3_6Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q3_6);
        answer1.setText(R.string.a3_6_1);
        answer2.setText(R.string.a3_6_2);
        answer3.setText(R.string.a3_6_3);
        answer4.setText(R.string.a3_6_4);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ3_7Fragment.newInstance());
    }
