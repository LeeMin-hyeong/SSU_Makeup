...
public class SurveyQ4_14Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ4_14Fragment newInstance() {
        return new SurveyQ4_14Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q4_14);
        answer1.setText(R.string.a4_14_1);
        answer2.setText(R.string.a4_14_2);
        answer3.setText(R.string.a4_14_3);
        answer4.setText(R.string.a4_14_4);
        answer5.setText(R.string.a4_14_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ4_15Fragment.newInstance());
    }
