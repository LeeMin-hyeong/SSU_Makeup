...
public class SurveyQ1_3Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ1_3Fragment newInstance() {
        return new SurveyQ1_3Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q1_3);
        answer1.setText(R.string.a1_3_1);
        answer2.setText(R.string.a1_3_2);
        answer3.setText(R.string.a1_3_3);
        answer4.setText(R.string.a1_3_4);
        answer5.setText(R.string.a1_3_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ1_4Fragment.newInstance());
    }
