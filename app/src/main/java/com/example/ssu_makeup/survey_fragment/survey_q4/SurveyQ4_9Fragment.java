...
public class SurveyQ4_9Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,4,9);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ4_10Fragment.newInstance());
    }
