...
public class SurveyQ3_13Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ3_13Fragment newInstance() {
        return new SurveyQ3_13Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q3_13);
        answer1.setText(R.string.a3_13_1);
        answer2.setText(R.string.a3_13_2);
        answer3.setText(R.string.a3_13_3);
        answer4.setText(R.string.a3_13_4);
        answer5.setText(R.string.a3_13_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ3_14Fragment.newInstance());
    }
