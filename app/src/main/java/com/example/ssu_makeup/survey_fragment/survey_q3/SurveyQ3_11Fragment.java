...
public class SurveyQ3_11Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ3_11Fragment newInstance() {
        return new SurveyQ3_11Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q3_11);
        answer1.setText(R.string.a3_11_1);
        answer2.setText(R.string.a3_11_2);
        answer3.setText(R.string.a3_11_3);
        answer4.setText(R.string.a3_11_4);
        answer5.setText(R.string.a3_11_5);
    ...
    public void onClick(View view) {
        ...
        ((SurveyActivity)getActivity()).replaceFragment(SurveyQ3_12Fragment.newInstance());
    }
    ...
    public void setButtons(){
        ...
        answer5.setBackgroundResource(R.drawable.round_corners_dynamic_color);
    }
}