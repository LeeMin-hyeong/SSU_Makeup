...
public class SurveyQ2_15Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ2_15Fragment newInstance() {
        return new SurveyQ2_15Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q2_15);
        answer1.setText(R.string.a2_15_1);
        answer2.setText(R.string.a2_15_2);
        answer3.setText(R.string.a2_15_3);
        answer4.setText(R.string.a2_15_4);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,2,15);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ2_16Fragment.newInstance());
    }
