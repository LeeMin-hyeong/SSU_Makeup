...
public class SurveyQ2_2Fragment extends Fragment implements View.OnClickListener{
    ...
    public static SurveyQ2_2Fragment newInstance() {
        return new SurveyQ2_2Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q2_2);
        answer1.setText(R.string.a2_2_1);
        answer2.setText(R.string.a2_2_2);
        answer3.setText(R.string.a2_2_3);
        answer4.setText(R.string.a2_2_4);
        answer5.setText(R.string.a2_2_5);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore5AnswersIgnore(view,2,2);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ2_3Fragment.newInstance());
    }
