...
public class SurveyQ3_12Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
    ...
    public static SurveyQ3_12Fragment newInstance() {
        return new SurveyQ3_12Fragment();
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q3_12);
        answer1.setText(R.string.a3_12_1);
        answer2.setText(R.string.a3_12_2);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,3,12);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ3_13Fragment.newInstance());
    }
