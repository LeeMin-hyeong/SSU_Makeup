...
public class SurveyQ1_6Fragment extends Fragment implements View.OnClickListener{
    TextView question;
    Button answer1;
    Button answer2;
    Button answer3;
...
//    Button answer5;
    ...
    public static SurveyQ1_6Fragment newInstance() {
        return new SurveyQ1_6Fragment();
    }
    @Override
...
//        answer5 = root.findViewById(R.id.answer5);
        ...
        question.setText(R.string.q1_6);
        answer1.setText(R.string.a1_6_1);
        answer2.setText(R.string.a1_6_2);
        answer3.setText(R.string.a1_6_3);
        answer4.setText(R.string.a1_6_4);
//        answer5.setText(R.string.a1_6_5);
...
//        answer5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore4Answers(view,1,6);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ1_7Fragment.newInstance());
    }
