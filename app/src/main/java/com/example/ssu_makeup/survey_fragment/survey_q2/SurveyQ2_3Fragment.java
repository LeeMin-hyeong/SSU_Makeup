...
public class SurveyQ2_3Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        question.setText(R.string.q2_3);
        answer1.setText(R.string.a2_3_1);
        answer2.setText(R.string.a2_3_2);
        answer3.setText(R.string.a2_3_3);
        answer4.setText(R.string.a2_3_4);
        answer5.setText(R.string.a2_3_5);
    ...
    public void onClick(View view) {
        ...
        Baumann.addScore5AnswersIgnore(view,2,3);
        ((SurveyActivity)requireActivity()).replaceFragment(SurveyQ2_4Fragment.newInstance());
    }
